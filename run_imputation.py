...
if __name__ == '__main__':
    ...
    t_knn_product = [(t, knn) for knn_dist in nn_dist_selection
...
def run_magic_evaluation_pipeline_synth_data(t_knn_dist_pair, n_jobs=-1):
    '''
    Partial function on the same ground truth dataset
    '''
    t, knn_dst = t_knn_dist_pair
    return run_magic_evaluation_pipeline(true_adata=ground_truth_adata, procesed_adata=processed_tenx_adata, t=t, knn_dist=knn_dist, n_jobs=n_jobs)
